...
var MM = {
  ...
  getAdjacentLinks: function getAdjacentLinks(currentLinkSrc) {
    ...
    console.log('about to call populateAdjacentLinks');
  ...
  populateAdjacentLinks: function populateAdjacentLinks(prevLink, nextLink) {
    var modalPrev = document.querySelector("#modal-prev");
    var modalNext = document.querySelector("#modal-next"); // console.log('prevLink', prevLink)
    ...
    if (prevLink) {
      ...
      }, false); // modalPrev.addEventListener('click', MM.handlePopulateModal(event, prevLinkSrc, prevLinkTitle))
    } else {
    ...
    if (nextLink) {
      ...
      }, false); // modalNext.addEventListener('click', MM.handlePopulateModal(event, nextLinkSrc, nextLinkTitle))
    } else {
      modalNext.style.top = "-100px";
    }
  },
  clearModal: function clearModal(modalImage, modalText, prevLink, nextLink) {
    modalImage.alt = "";
    modalImage.src = "";
    modalText.innerHTML = "";
    modalImage.style = ""; // prevLink.removeEventListener("click", MM.handlePopulateModal);
  ...
  closeModal: function closeModal() {
    ...
    var modalImage = document.querySelector('#modal-image');
    var modalText = document.querySelector('#modal-text');
    var prevLink = document.querySelector("#modal-prev");
    var nextLink = document.querySelector("#modal-next");
...
//# sourceMappingURL=main.2a5ec7dd6210eb052cc2.hot-update.js.map